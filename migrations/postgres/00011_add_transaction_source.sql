...
-- existing row correctly (all current data is SimpleFIN). Source is never written
-- by UpdateTransactionFromSync, so re-syncs leave it intact: the lineage is
-- immutable, like labels and extensions.
