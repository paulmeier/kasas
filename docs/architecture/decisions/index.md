...
| ADR | Title | Status |
| --- | --- | --- |
| [0001](0001-plugin-dependency-bundling.md) | Allow bundled dependencies in plugins | Proposed |
| [0002](0002-plugin-network-capability.md) | Host-mediated plugin network access (`net:fetch`) | Proposed |
