...
kasas is free and open source under the [MIT License](./LICENSE) for personal,
non-commercial, and open-source use.

A **commercial license** is available for organizations that want to:

- Offer kasas (or a derivative) as a hosted/SaaS product
- Embed kasas in a proprietary commercial product
- Remove attribution requirements
- Receive a support SLA or warranty
