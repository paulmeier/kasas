...
| 📜 **[Events & history](https://paulmeier.github.io/kasas/features/event-stream/)** | An append-only, replayable change log, plus an immutable full-snapshot history per transaction. |
